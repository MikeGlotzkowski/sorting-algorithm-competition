...
class ReconnectingMqttConsumer(object):
    def __init__(self, amqp_url, logger):
        self._logger = logger
        self._reconnect_delay = 0
        self._amqp_url = amqp_url
        self._consumer = MqttConsumer(self._amqp_url, self._logger)
...
#     amqp_url = 'amqp://python-native:python-native@rabbitmq.sorting-queue.svc:5672/competition1'
#     consumer = ReconnectingMqttConsumer(amqp_url)
#     consumer.run()
